...
const authController = {
  ...
  register: async (req, res) => {
    try {
      ...
      return sendResponse(res, 201, true, 'User registered successfully', { id: result.insertId });
    } catch (error) {
  ...
  getProfile: async (req, res) => {
    try {
      ...
      return sendResponse(res, 200, true, 'Profile retrieved successfully', users[0]);
    } catch (error) {
  ...
  refreshToken: async (req, res) => {
    try {
      ...
      return sendResponse(res, 200, true, 'Token refreshed successfully', { token: newToken });
    } catch (error) {
