...
-- Final version using CREATE OR REPLACE
...
-- Update status
CREATE OR REPLACE PROCEDURE UpdatePortfolioStatus(
    IN p_id INT,
    IN p_status ENUM('draft', 'published', 'archived')
)
BEGIN
...
CREATE OR REPLACE PROCEDURE CreateContactInquiry(
    IN p_name VARCHAR(255),
    IN p_email VARCHAR(255),
...
CREATE OR REPLACE PROCEDURE UpdateContactStatus(
    IN p_id INT,
