            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-16">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Frontend</h3>
                    <p className="text-muted-foreground">React, TypeScript, Tailwind CSS, Next.js</p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-foreground mb-2">Backend</h3>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Git, Docker, AWS, Vercel</p>
                  </div>
                </div>
              </div>
            </div>
