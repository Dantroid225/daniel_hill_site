      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Manage your portfolio content, projects, and blog posts.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Blog Posts</h3>
                <p className="text-muted-foreground mb-4">
                  Create and edit blog posts to share your knowledge.
                </p>
            ...
            <Card>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">Backup</h3>
                <p className="text-muted-foreground mb-4">
